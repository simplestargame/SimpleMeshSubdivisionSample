# Simple Mesh Subdivision Sample

Welcome to the Simple Mesh Subdivision Sample repository!  
This repository is a sample for mesh subdivision around each coordinate of interest input.   
Its technical excellence lies in its ability to perform mesh subdivision quickly without imposing a load on the main thread.  
...
メインスレッドに負荷をかけることなく、それでいて素早くメッシュ細分化ができる所が技術的に優れたポイントです。    
